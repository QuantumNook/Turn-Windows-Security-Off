...
const APP_CONFIG = {
    ...
    enableConsoleLogging: true, // Keeping true for debugging, set to false for production if desired.
...
});t to 'true' to show debug messages in the console, 'false' to suppress them.
